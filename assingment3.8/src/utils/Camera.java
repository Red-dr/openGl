...
//	}
	...
	public void forward(){
		movement(cameye, yaw_angle, pitch_angle, movement);
	}
	public void backward(){
		movement(cameye, yaw_angle, pitch_angle, -movement);
	}
	public void strafe_left(){
		movement(lookAt, yaw_angle, 0, movement);
	}
	public void strafe_right(){
		movement(lookAt, 0, pitch_angle, -movement);
	}
 ...
 */
	  ...
	  public void think(){
		 ...
		 if(forward)	{forward();}
		 if(back)    	{backward();}
		 if(sleft)  	{strafe_left();}
		 if(sright) 	{strafe_right();}
		 update_look_at();
	  }
